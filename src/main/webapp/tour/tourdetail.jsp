                ...
                <div class="col-sm-12">
                    ...
                    <c:forEach var="list" items="${tour_detail}">
                        ...
                        <div>
                            ...
                            <div style="font-size: 20px">${list.overview}</div>
                            <!-- 한 줄 소개 -->
                 ...
                 <div>
                        <img id="tri2" src="" style="width:220px ; height:250px">
                        <img id="tri3" src="" style="width:220px ; height:250px">
                        <img id="tri4" src="" style="width:220px ; height:250px">
                        <img id="tri5" src="" style="width:220px ; height:250px">
                        <img id="tri6" src="" style="width:220px ; height:250px">
                        </div>                        
                 </div>           
        </div>
    </section>
