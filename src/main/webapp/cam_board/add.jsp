...
<div class="culmn">
	...
	<section style="background-color: rgba(0,0,0,0.05)">
		<form action="${pageContext.request.contextPath }/cam_board/add.do" method="post" enctype="multipart/form-data">
			<div class="container" style="margin-top: 15px; margin-bottom: 30px">
				<div class="member">
					<div class="col-sm-2"></div>
					<div class="col-sm-8 box-center" style="background-color: white">
						<div style="margin-bottom: 30px; margin-top: 30px">
							<h3 style="color: black">새 게시글 작성</h3>
						</div>
						<div class="field">
							<b>Writer</b>
							<span><input type="text" name="writer" value="${sessionScope.loginId }" readonly></span>
						</div>
						<div class="field">
							<b>Area</b>
						...
						<div class="field">
							<b>Content</b>
							<span><textarea name="content" style="width: 100%"></textarea></span>
						</div><br>
						<div class="field">
							<b>Img 1</b>
							<span><input type="file" name="img1"></span>
						</div>
						<div class="field">
							<b>Img 2</b>
							<span><input type="file" name="img2"></span>
						</div>
						<div class="field">
							<b>Img 3</b>
							<span><input type="file" name="img3"></span>
						</div>
